...
function Intro() {
  return (
    <div
      id="intro"
      className="flex items-center bg-fixed lg:bg-contain bg-top flex-col w-full bg-no-repeat lg:h-120vh h-100vh bg-white mb-6 lg:pt-0 repeat-0 lg:justify-end"
      style={{
